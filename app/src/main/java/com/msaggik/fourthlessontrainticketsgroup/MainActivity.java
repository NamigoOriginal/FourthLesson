...
import com.msaggik.fourthlessontrainticketsgroup.model.RailwayTicketPen;
...
public class MainActivity extends AppCompatActivity {
    ...
    RailwayTicket railwayTicketPen = new RailwayTicketChild(70, 5, 30);
    ...
    private TextView railwayTicketPenOut; //
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        railwayTicketPenOut = findViewById(R.id.railwayTicketPenOut);
        ...
        railwayTicketPenOut.setText(Float.toString(railwayTicketPen.ticketPriceAll()) + " монет");
        ...
        railwayTicketTotalOut.setText(Float.toString(railwayTicket.ticketPriceAll() + railwayTicketChild.ticketPriceAll() + railwayTicketPen.ticketPriceAll() ) + " монет");
